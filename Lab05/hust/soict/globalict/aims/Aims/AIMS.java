package Lab05.hust.soict.globalict.aims.Aims;

import java.util.Scanner;

import javax.swing.JOptionPane;

import Lab05.hust.soict.globalict.aims.cart.*;
import Lab05.hust.soict.globalict.aims.exception.PlayerException;
import Lab05.hust.soict.globalict.aims.media.*;
import Lab05.hust.soict.globalict.aims.store.*;
...
public class AIMS {
            ...
            Scanner keyboard = new Scanner(System.in);
                ...
                if(input == 1){
                    ...
                    if(media instanceof CompactDisc){
                        ...
                        System.out.println("This type of media can not be played");
                     }
                     mediaDetailsMenu(media);
                    }else {
                    return;
            ...
            Scanner keyboard = new Scanner(System.in);
                ...
                if(input == 1){
                    ...
                    cartMenu();
                        ...
                        String option = keyboard.nextLine();
                        Media media = cart.search_by_title(option);;
    ...
    public static void setup(Store store){
