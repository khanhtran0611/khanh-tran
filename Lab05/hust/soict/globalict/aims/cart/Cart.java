package Lab05.hust.soict.globalict.aims.cart;
...
public class Cart {
    private ObservableList<Media> cart = FXCollections.observableArrayList();
    ...
    public Media search_by_title(String s){
    ...
    public Media search_by_id(int id){
        for(Media i : cart){
            if(i.getId() == id){
                i.toString();
                return i;
    ...
    public Media search_by_category(String category){
         for(Media i : cart){
